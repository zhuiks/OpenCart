          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane <?php if ($active_tab == 'webform') {echo "active";} ?>" id="webform">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="radio-inline">
                    <input type="radio" id="getresponse-form-active" class="form-control getresponse-form-active"<?php if ($getresponse_form['active'] == 1) { ?> checked<?php } ?> name="getresponse_form[active]" value="1"> <?php echo $label_yes; ?>
                  </div>
                  <div class="radio-inline">
                    <input type="radio" class="form-control getresponse-reg-active"<?php if ($getresponse_form['active'] != 1) { ?> checked<?php } ?> name="getresponse_form[active]" value="0"> <?php echo $label_no; ?>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="getresponse_form[id]" id="getresponse-form-id" class="form-control">
                    ...
                    <option value="<?php echo $form['id']; ?>"<?php if ($getresponse_form['id'] == $form['id']) { ?> selected<?php } ?> data-url="<?php echo $form['url']; ?>"><?php echo $form['name']; ?></option>
                    <?php } ?>
                    </optgroup>
                    <?php } ?>
